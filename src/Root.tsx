  ...
  return (
    <div className="mx-0 h-full w-full max-w-6xl py-1">
        ...
        >
          <div className="flex w-full flex-row items-center transition-all">
            ...
            <svg
              ...
              className="ml-2 h-9 w-9 cursor-pointer p-1 transition-all duration-300 hover:scale-110 hover:transition"
      ...
      >
        ...
        <Link
          to="/"
          className="flex w-10/12 cursor-pointer flex-row items-center justify-start gap-4 rounded-md py-3 pl-5 transition-colors duration-150 hover:bg-neutral-300/30"
